...
class AddPrenotazioneCommandTester
{

    private AddPrenotazioneCommand command;
    ...
    void setUp()
    {
        ...
        Cliente cliente = new Cliente("Valeria", "Bianchi", "Francese", "MI", "Milano", "Via Dante", 42, 20121, "3479876543", "F", LocalDate.of(1985, 12, 02), "BNCVLR85T42F205Z", "valeria.b@provider.it", "PayPal");
        ArrayList<Cliente> ospiti = new ArrayList<>(List.of(cliente, new Cliente("Valeria", "Bianchi", "Francese", "MI", "Milano", "Via Dante", 42, 20121, "3479876543", "F", LocalDate.of(1985, 12, 02), "BNCVLR85T42F205Z", "valeria.b@provider.it", "PayPal")));
        ...
        command = new AddPrenotazioneCommand(catalogue, prenotazioneTest);
    }
    ...
    {
        // Act
        AddPrenotazioneCommand emptyCommand = new AddPrenotazioneCommand();
...
// Istanza di Prenotazione
    ...
    @Test
    void testExecuteAddsPrenotazioneToList()
    {
        // Arrange
    ...
    @Test
    void testExecuteDoSave() throws SQLException
    {
        // Arrange
        ArrayList<Prenotazione> listaPrenotazioni = new ArrayList<>();
        CatalogoPrenotazioni.setListaPrenotazioni(listaPrenotazioni);
    ...
    @Test
    void testExecuteSQLException() throws SQLException
    {
        // Arrange
        ArrayList<Prenotazione> listaPrenotazioni = new ArrayList<>();
        CatalogoPrenotazioni.setListaPrenotazioni(listaPrenotazioni);
    ...
    @Test
    void testUndoRemovesPrenotazioneFromList() throws CloneNotSupportedException
    {
        // Arrange
        ArrayList<Prenotazione> listaPrenotazioni = new ArrayList<>();
    ...
    @Test
    void testUndoDoDelete() throws SQLException, CloneNotSupportedException
    {
        // Arrange
        ArrayList<Prenotazione> listaPrenotazioni = new ArrayList<>();
        listaPrenotazioni.add(prenotazioneTest);
