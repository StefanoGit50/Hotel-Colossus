...
import it.unisa.Server.commandPattern.CatalogoClientiCommands.RemoveClienteCommand;
...
//        command = new RemoveClienteCommand(catalogue, clienteTest);
    ...
    @Test
    void testExecuteCallsDoDeleteForNonBannedCliente() throws SQLException, CloneNotSupportedException, IllegalAccess {
        // Arrange
        ArrayList<Cliente> listaClienti = new ArrayList<>();
        listaClienti.add(clienteTest);
        CatalogoClienti.setListaClienti(listaClienti);
