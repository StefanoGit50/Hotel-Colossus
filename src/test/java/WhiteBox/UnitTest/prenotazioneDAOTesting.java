...
public class prenotazioneDAOTesting {
    ...
    public void doRetriveByAttribute() throws SQLException {
        ...
        servizios.add(new Servizio("Lavanderia",15.0));
        cameras.add(new Camera(101,Stato.Libera,2,120,"Camera doppia con vista mare"));
        prenotaziones.add(new Prenotazione(1,LocalDate.of(2026,1,15),LocalDate.of(2026,2,1),LocalDate.of(2026,2,5),new Trattamento("Pensione Completa",50.0),"Passaporto", LocalDate.of(2020,1,15),LocalDate.of(2030,1,1),"Maria Verdi","Richiesta camera silenziosa",cameras,servizios,clientes,"AX123456"));
        Object o = "AX123456";
