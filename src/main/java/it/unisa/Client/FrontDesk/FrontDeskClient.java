        ...
        try 
        {
              ...
              //   System.out.println("Id: " + p.getId() + "   \n\tNumero stanza: " + p.getStanza().getNumero() + "\n\tNome cliente: " + p.getCliente().getNome());
                    ...
                    case 7:{
                        ...
                        AddClienteCommand addClienteCommand = new AddClienteCommand(new CatalogoClienti() , new it.unisa.Common.Cliente("Francesco" , "Moretto" ,  "Salerno" , "Capezzano" , "corso armando diaz " , 10 , 84054 , "324677894018" , "Maschio" , LocalDate.of(2016,12,30) , "MRTFCS16T30H703C"  ,"Cartaceo","Italiana",new Camera()));
