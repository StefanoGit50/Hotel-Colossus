...
class RemoveClienteCommandTester {
    ...
    void setUp() {
        ...
        clienteBannatoTest = new Cliente("Valeria", "Bianchi", "Francese", "MI", "Milano", "Via Dante", 42, 20121, "3479876543", "F", LocalDate.of(1985, 12, 02), "BNCVLR85T42F205Z", "valeria.b@provider.it", "PayPal");
