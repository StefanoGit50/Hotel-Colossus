...
INSERT INTO Cliente2 (CF, nome, cognome, Cap, comune, civico, provincia, via, Email, Sesso, telefono, Cittadinanza, Nazionalità, DataDiNascita, IsBackListed)
VALUES 
('RSSMRA85M01H501Z', 'Mario', 'Rossi', '80100', 'Napoli', 15, 'Napoli', 'Via Roma', 'mario.rossi@email.it', 'Maschio', '3331234567', 'Italiana', 'Italiana', '1985-08-01', FALSE),
...
INSERT INTO Camera2 (NumeroCamera, NumeroMaxOcc, NoteCamera, Stato, Prezzo)
VALUES 
...
INSERT INTO Prenotazione2 (DataPrenotazione, DataArrivoCliente, DataPartenzaCliente, NomeTrattamento, NoteAggiuntive, Intestatario, dataScadenza, numeroDocumento, DataRilascio, TipoDocumento, Stato, ChekIn)
VALUES 
...
INSERT INTO Trattamento2 (Nome, Prezzo, IDPrenotazione)
VALUES 
('Pensione Completa', 50.00, 1),
('Mezza Pensione', 30.00, 2);

-- INSERT per Servizio2 (2 servizi)
INSERT INTO Servizio2 (Nome, Prezzo, IDPrenotazione)
VALUES 
('Lavanderia', 15.00, 1),
('Spa e Benessere', 40.00, 2);

-- INSERT per Associato_a2 (2 associazioni)
INSERT INTO Associato_a2 (CF, NumeroCamera, IDPrenotazione, PrezzoAcquisto)
VALUES 
('RSSMRA85M01H501Z', 101, 1, 120.00),
('VRDLRA90D45F839Y', 102, 2, 180.00);

-- INSERT per RicevutaFiscale2 (2 ricevute)
INSERT INTO RicevutaFiscale2 (IDRicevutaFiscale, IDPrenotazione, DataEmissione, metodoPagamento, DataPrenotazione, PrezzoTrattamento, TipoTrattamento)
VALUES 
...
INSERT INTO ClientiRicevuta2 (CFCliente, IDRicevutaFiscale, NomeCliente, CognomeCliente, isIntestatario)
VALUES 
...
INSERT INTO CameraRicevuta2 (IDRicevutaFiscale, NumeroCamera, PrezzoCamera)
VALUES 
(1001, 101, 120.00),
(1002, 102, 180.00);

-- INSERT per ServiziRicevuta2 (2 servizi in ricevuta)
INSERT INTO ServiziRicevuta2 (IDRicevutaFiscale, NomeServizio, Quantità, PrezzoServizio)
VALUES 
(1001, 'Lavanderia', 2, 15.00),
(1002, 'Spa e Benessere', 1, 40.00);

-- INSERT per Impiegato2 (2 impiegati)
INSERT INTO Impiegato2 (CF, Stipedio, UserName, HashPasword, isTempurali, dataScadenzaToken, Nome, Cognome, Cap, DataAssunzione, Telefono, Cittadinanza, EmailAziendale, Sesso, Ruolo, DataRilascio, TipoDocumento, Via, Provincia, Comune, Civico, NumeroDocumento, DataScadenza, IDImpiegato1, CF1)
VALUES 
