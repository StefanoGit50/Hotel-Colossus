...
VALUES
    (101, 'Camera Standard', 2, 'Vista cortile', 'Libera', 80),
    (102, 'Camera Standard Plus', 2, 'Vista strada', 'Libera', 90),
    (103, 'Camera Deluxe', 2, 'Balcone', 'Prenotata', 120),
    (104, 'Camera Family', 4, '4 posti', 'Libera', 150),
    (201, 'Junior Suite', 3, 'Vista mare', 'Occupata', 180),
    (202, 'Camera Superior', 2, 'Panoramica', 'Libera', 110),
    (301, 'Suite Presidenziale', 4, 'Jacuzzi', 'Libera', 350),
    (302, 'Camera Executive', 2, 'Business', 'Prenotata', 130);

-- =============================================
-- INSERT PRENOTAZIONE
-- =============================================
INSERT INTO Prenotazione
(NomeIntestatario, DataCreazionePrenotazione, DataArrivoCliente,
 DataPartenzaCliente, NumeroDocumento,
 DataRilascioDocumento, DataScadenzaDocumento,
 NomeTrattamento, TipoDocumento, Stato, CheckIn,
 PrezzoAcquistoTrattamento, MetodoPagamento)
VALUES
    ('Leonardo Ferrari', '2025-01-10', '2025-01-15', '2025-01-20',
     'AA1111111', '2020-01-01', '2030-01-01',
     'Bed & Breakfast', 'Carta Identità', true, true, 15, 'Carta');

-- salva ID reali
SELECT IDPrenotazione INTO @p1 FROM Prenotazione
WHERE NomeIntestatario = 'Leonardo Ferrari';
