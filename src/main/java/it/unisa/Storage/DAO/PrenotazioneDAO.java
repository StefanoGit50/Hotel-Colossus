...
public class PrenotazioneDAO implements FrontDeskStorage<Prenotazione>
{
    ...
    @Override
    public void doDelete(Prenotazione p) throws SQLException
    {
        Connection connection = ConnectionStorage.getConnection();
                        ...
                        try (ResultSet rs4 = stmt.executeQuery()) {
                            while (rs4.next()) {
                                clienti.add(new Cliente(
                                        ...
                                        rs4.getInt("civico"),
                                        rs4.getInt("Cap"),
                                        Integer.parseInt(rs4.getString("telefono")),
                                        rs4.getString("Sesso"),
    ...
    @Override
    public Collection<Prenotazione> doRetriveAll(String order) throws SQLException
    {
        Connection connection = ConnectionStorage.getConnection();
